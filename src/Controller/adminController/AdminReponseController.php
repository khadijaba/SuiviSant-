...
final class AdminReponseController extends AbstractController
{
    ...
    #[Route('/new/{questionId}', name: 'app_admin_reponse_new', methods: ['GET', 'POST'])]
public function new(Request $request, EntityManagerInterface $entityManager, int $questionId): Response
{
    ...
    if ($form->isSubmitted() && $form->isValid()) {
        ...
        return $this->redirectToRoute('app_admin_question_show', ['id' => $questionId], Response::HTTP_SEE_OTHER);
    }
